...
- **FID Score:** **87.94** (Calculated against 1,000 real vs 1,000 generated samples).
...
### Google Colab (Proof of Work)

For easy demonstration and cloud training, use the provided notebook:
- **Notebook**: `train_and_sample_colab.ipynb`
- **Features**: Automated environment setup, Drive mounting, training loop with WandB integration, and FID calculation.
